...
private:
    ...
    Scene scenes[8] = {
        ...
        {GO_STRAIGHT, 0, 540, 80, 0.9f,  0.0f, 103.0f},
        {LINE_TRACE, 0, 865, 80, 0.9f,  0.0f, 103.0f},
        {GO_STRAIGHT, 0, 780, 80, 0.9f,  0.0f, 103.0f},
        {LINE_TRACE, 0, 89, 50, 0.9f,  0.0f, 103.0f},
        {GO_STRAIGHT, 0, 300, 50, 0.9f,  0.0f, 103.0f},
        {GO_STRAIGHT, 0, 300, 50, 0.9f,  0.0f, 103.0f},
