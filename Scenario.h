...
private:
    ...
    Scene scenes[3] = {
        ...
        */
        ...
        //{LINE_TRACE, 0U, 300, 100, 0.9f,  0.0f, 103.0f},
        //{GO_STRAIGHT_UNTIL_TIME, 5U * 1000000U, 60000, 100, 0.9f,  0.0f, 103.0f},
        //{LINE_TRACE_ON_BLUE, 0, 400, 10, 0.9f,  0.0f, 103.0f},
        //{LINE_TRACE_UNTIL_BLUE, 0, 300, 10, 0.9f,  0.0f, 103.0f},
        //{TURN, 0, 180, 20, 0.0f, 0.0f, 0.0f},
        //{END, 0, 0, 0, 0.0f, 0.0f, 0.0f}
        //{GO_STRAIGHT, 0, 370, 0, 0.9f,  0.0f, 103.0f},
        //{LINE_TRACE_UNTIL_TIME, 175U * 100000U, 60000, 100, 0.9f,  0.0f, 103.0f},
        {LINE_TRACE_UNTIL_BLUE, 0, 300, 0, 0.9f,  0.0f, 103.0f},
        {LINE_TRACE_ON_BLUE, 0, 400, 10, 0.9f,  0.0f, 103.0f},
        {END, 0, 0, 0, 0.0f, 0.0f, 0.0f}
    };
